...
public class RoundPeg extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 8211518391906905653L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"RoundPeg\",\"namespace\":\"com.example.dlq.objects\",\"fields\":[{\"name\":\"diameter\",\"type\":\"int\",\"doc\":\"Diameter of the round peg face\"}],\"version\":\"1\"}");
   ...
   */
  public static com.example.dlq.objects.RoundPeg.Builder newBuilder() {
    return new com.example.dlq.objects.RoundPeg.Builder();
  }
   ...
   * @return A new RoundPeg RecordBuilder
   */
  public static com.example.dlq.objects.RoundPeg.Builder newBuilder(com.example.dlq.objects.RoundPeg.Builder other) {
    if (other == null) {
      return new com.example.dlq.objects.RoundPeg.Builder();
    } else {
      return new com.example.dlq.objects.RoundPeg.Builder(other);
    }
  }
   ...
   * @return A new RoundPeg RecordBuilder
   */
  public static com.example.dlq.objects.RoundPeg.Builder newBuilder(com.example.dlq.objects.RoundPeg other) {
    if (other == null) {
      return new com.example.dlq.objects.RoundPeg.Builder();
    } else {
      return new com.example.dlq.objects.RoundPeg.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<RoundPeg>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.example.dlq.objects.RoundPeg.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.example.dlq.objects.RoundPeg other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.diameter)) {
        this.diameter = data().deepCopy(fields()[0].schema(), other.diameter);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.dlq.objects.RoundPeg.Builder setDiameter(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.dlq.objects.RoundPeg.Builder clearDiameter() {
